if Rails.env.development?
  ...
  6.times do |n|
    author.posts.create!(
      ...
      <p style="text-align: justify; margin-left: 40px;"><span style="font-family:Trebuchet MS,Helvetica,sans-serif;"><span style="font-size:18px;">One of the main advantages of working with an outsourcing company is retrenchment of costs. To be sure that you will stay on budget you should:</span></span></p>
      
      <ul dir="ltr">
        <li style="text-align: justify; margin-left: 40px;">◦&nbsp;<span style="font-family:Trebuchet MS,Helvetica,sans-serif;"><span style="font-size:18px;">Have a clear vision of what you want to develop with the help of outsourcing company;</span></span></li>
        <li style="text-align: justify; margin-left: 40px;">◦&nbsp;<span style="font-family:Trebuchet MS,Helvetica,sans-serif;"><span style="font-size:18px;">Have the final goal of that creation;</span></span></li>
        <li style="text-align: justify; margin-left: 40px;">◦&nbsp;<span style="font-family:Trebuchet MS,Helvetica,sans-serif;"><span style="font-size:18px;">Define functions it must perform;</span></span></li>
        <li style="text-align: justify; margin-left: 40px;">◦&nbsp;<span style="font-family:Trebuchet MS,Helvetica,sans-serif;"><span style="font-size:18px;">Estimate the time duration of cooperation with offshore members.</span></span></li>
      </ul>
