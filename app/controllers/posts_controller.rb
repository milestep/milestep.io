class PostsController < ApplicationController
  ...
  def set_meta_tags
    meta_tags = { 
      twitter_description: helpers.cut_text(ActionController::Base.helpers.strip_tags(helpers.get_html_text_for_meta_tag(@post.body)), 300),
      twitter_title: @post.title,
      twitter_image: ActionController::Base.helpers.image_url(@post.main_image),
      og_title: @post.title,
      og_type: "article",
      og_description: helpers.cut_text(ActionController::Base.helpers.strip_tags(helpers.get_html_text_for_meta_tag(@post.body)), 300),
