module PostsHelper
  ...
  def generate_meta_tag_from_post(post)
    { 
      twitter_description: cut_text(ActionController::Base.helpers.strip_tags(get_html_text_for_meta_tag(post.body)), 300),
      twitter_title: post.title,
      twitter_image: ActionController::Base.helpers.image_url(post.main_image),
      og_title: post.title,
      og_type: "article",
      og_description: cut_text(ActionController::Base.helpers.strip_tags(get_html_text_for_meta_tag(post.body)), 300),
